...
<defs>
  <style>
    ...
    .animated-text-white {
      animation: textStrokeWhite 2s ease-out forwards;
    }
...
<g id="_layer_1-2" data-name="layer 1">
  <g>
    ...
    <g>
      ...
      <text id="ranking-input" class="cls-5 animated-text-white" transform="translate(134.82 176.36)" text-anchor="end" alignment-baseline="middle"><tspan x="0" y="0">${userRank}</tspan></text>
      <g id="rankit-logo">
      ...
      <text id="lang-input" class="cls-1 animated-text-white" transform="translate(73.98 88.7)" text-anchor="middle" alignment-baseline="middle"><tspan x="0" y="0">${langName}</tspan></text>
    </g>
